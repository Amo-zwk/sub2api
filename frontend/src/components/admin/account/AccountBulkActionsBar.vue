<template>
  <div class="flex min-h-12 flex-wrap items-center justify-between gap-2 border-b border-primary-100 bg-primary-50/80 px-4 py-2 dark:border-primary-900/40 dark:bg-primary-900/20">
